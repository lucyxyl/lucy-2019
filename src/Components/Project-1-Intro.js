  ...
  return (
    <div>
      <Content>
        ...
        <Txt>
          Appneta enables enterprise IT teams to monitor & analyze network and application traffic across their
          network architecture. One of the most frequented interface is the Network Paths page. This is a live feed
          of performance data from all the network paths that's been deployed. The number of paths a single user
          looks at can range from two digits all the way up to couple thousands. For larger deployments, the query
          is the only way to get to paths of interest.
          <br />
          <br />
          I led the re-thinking of the query experience as a foundation to resolve the scalability bottlenecks we
          were experiencing.
          <br />
          <br />
        ...
        <InnerBlockLeft>
          <Row>
            <h1>1.</h1>
            <Listln>
              Break apart the various search architectures, product entities that floated across the product.
            </Listln>
          </Row>
          <Row>
            <h1>2.</h1>
